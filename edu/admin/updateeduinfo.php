		...
		<div class="row" >
			<div class="col-md-12" >
				<h2 class="text-center">
				   ...
				   <h2 class="text-align: center;">UPDATE EDUCATION INFORMATION</h2>
		...
		<div class="col-md-6 col-md-offset-3 " style="margin-top: 20px ">
			<div  style="text-align: center; margin-bottom: -10px;">
                ...
                <input type="text" name="location" placeholder="Enter The Location Name" style="width: 240px;height: 35px;">
                  ...
                  <input type="submit" name="search" value="Search" class="btn btn-success text-center" style="margin-left: 30px; background-color:blue;" >  
                 </form>
			</div>
		</div>
	</div>
